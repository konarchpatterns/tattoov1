...
const products = [
  { id: 1, name: 'Samurai Warrior', price: '499 INR', oldPrice: null, img: '/images/sc_samurai.png' },
  { id: 2, name: 'Leo Constellation', price: '299 INR', oldPrice: null, img: '/images/sc_leo.png' },
  { id: 3, name: 'Coiled Snake', price: '399 INR', oldPrice: '499 INR', img: '/images/sc_snake.png' },
  { id: 4, name: 'Astronaut Explorer', price: '699 INR', oldPrice: null, img: '/images/sc_astronaut.png' },
  { id: 5, name: 'Cyberpunk Geisha', price: '199 INR', oldPrice: '499 INR', img: '/images/sc_geisha.png' },
  { id: 6, name: 'Oni Demon Mask', price: '599 INR', oldPrice: null, img: '/images/sc_oni.png' },
  { id: 7, name: 'Dragon Ascending', price: '799 INR', oldPrice: null, img: '/images/sc_dragon.png' },
  { id: 8, name: 'Y2K Star Tattoo', price: '899 INR', oldPrice: null, img: '/images/cat_new.png' }
];
      ...
      <section id="shop" className="special-collections-section container">
        ...
        <div className="sc-product-grid">
          {products.map(product => (
            <div key={product.id} className="sc-product-card-wrapper">
              <div className="sc-product-card">
                ...
                <img src={product.img} alt={product.name} className="sc-product-image" />
